 ...
 */
    ...
    */
    function _healthFactor (address user) private view returns(uint256){
        ...
        (uint256 totlaDscMinted, uint256 collaterValueInUsd) = _getAccountInformation(user);
        uint256 collateralAdjustedForThreshold = (collaterValueInUsd * LIQUIDATION_THRESHOLD)/ LIQUIDATION_PRECISION;
   ...
   function getAccountCollateralValue(address user) public view returns(uint256 toalCollateralValueInUsd){
